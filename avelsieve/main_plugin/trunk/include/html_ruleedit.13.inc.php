 ...
 *
 * @version $Id: html_ruleedit.13.inc.php,v 1.1 2007/03/12 14:56:00 avel Exp $
...
class avelsieve_html_edit_13 extends avelsieve_html_edit {
    ...
    */
   function avelsieve_html_edit_13(&$s, $mode = 'edit', $popup = false) {
   ...
   function edit_rule($edit = false) {
      ...
      $out .= $this->section_start( _("Custom Rule") ).
            '<div style="text-align: center; margin-left: auto; margin-right: auto;">
              <textarea name="customrule" cols="60" rows="25">'.
              htmlspecialchars($this->rule['code']) ."\n".
             '</textarea>
              </div>'.
            $this->section_end();
